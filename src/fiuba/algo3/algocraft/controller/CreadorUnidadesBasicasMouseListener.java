...
public class CreadorUnidadesBasicasMouseListener extends MouseAdapter {
	//private VentanaMapa ventanaMapa;
	private AlgoCraft juego;
	private Posicion posicionCeldaPresionada;
	
    public CreadorUnidadesBasicasMouseListener(VentanaMapa ventanaMapa, AlgoCraft juego, Posicion posicionCeldaPresionada) {
