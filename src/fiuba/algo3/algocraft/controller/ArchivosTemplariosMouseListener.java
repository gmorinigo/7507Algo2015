...
public class ArchivosTemplariosMouseListener extends MouseAdapter {
	//private VentanaMapa ventanaMapa;
	private AlgoCraft juego;
	private Posicion posicionCeldaPresionada;
	
    public ArchivosTemplariosMouseListener(VentanaMapa ventanaMapa, AlgoCraft juego, Posicion posicionCeldaPresionada) {
	...
	public void mouseReleased(MouseEvent arg0) {		
		...
		try {
			this.juego.agregarConstruccion(this.juego.dameElJugadorDelTurno(),TipoConstruccion.creadorUnidadesEspeciales,posicionCeldaPresionada);
