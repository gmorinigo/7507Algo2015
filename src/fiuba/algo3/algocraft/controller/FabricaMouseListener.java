...
public class FabricaMouseListener extends MouseAdapter {
	//private VentanaMapa ventanaMapa;
	private AlgoCraft juego;
	private Posicion posicionCeldaPresionada;
	
    public FabricaMouseListener(VentanaMapa ventanaMapa, AlgoCraft juego, Posicion posicionCeldaPresionada) {
	...
	public void mouseReleased(MouseEvent arg0) {		
		...
		try {
			this.juego.agregarConstruccion(this.juego.dameElJugadorDelTurno(),TipoConstruccion.creadorUnidadesNivel2,posicionCeldaPresionada);
